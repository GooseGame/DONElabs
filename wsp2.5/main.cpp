...
void initBallGenerator(PRNG &generator)
{
...
void onMouseClick(const sf::Event::MouseButtonEvent &event, std::vector<Ball> &ball_count, sf::Color (&pattern)[8], PRNG &generator)
{
    ...
    {
        Ball createdNewBall;
        createdNewBall.speed = {randomFloat(generator, -250.f, 200.f), randomFloat(generator, -50.f, 250.f)};
